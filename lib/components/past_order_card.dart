...
import 'package:instaport_customer/utils/capitalize.dart';

class PastOrderCard extends StatelessWidget {
  final Orders data;
  const PastOrderCard({super.key, required this.data});
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  width: 70,
                  decoration: BoxDecoration(
                      color: data.payment_method == "cod" ? const Color.fromRGBO(255, 76, 76, 1) :const Color.fromRGBO(24, 209, 172, 1),
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      data.payment_method == "cod" ? data.payment_method.toUpperCase() : capitalize(text: data.payment_method),
                      style: GoogleFonts.poppins(
                        color: Colors.white,
                        fontSize: 12,
